...
public class SearchCarsPage extends Utility {
    ...
    @CacheLookup
    @FindBy(xpath = "//select[@id='makes' and @class='form-control']")
    WebElement makeDropDown;

    @CacheLookup
    @FindBy(xpath = "//select[@id='models' and @class='form-control']")
    WebElement modelDropDown;

    @CacheLookup
    @FindBy(xpath = "//select[@id='locations' and @class='form-control']")
    WebElement locationDropDown;

    @CacheLookup
    @FindBy(xpath = "//select[@id='priceTo' and @class='form-control']")
